...
# Общая численность докторантов {#ind211_info}
...
* 2013 -
* 2014 - 
*	2015,	9,	19,	Общая численность докторантов,	чел.
*	2016,	9,	19,	Общая численность докторантов,	чел.
*	2017,	9,	19,	Общая численность докторантов,	чел.
*	2018,	9,	19,	Общая численность докторантов,	чел.
*	2019,	8,	19,	Общая численность докторантов,	чел.
*	2020,	8,	19,	Общая численность докторантов,	чел.
*	2021,	8,	19,	Общая численность докторантов,	чел.
...
```{r tab211formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab211, , 'tab211_data')
```
