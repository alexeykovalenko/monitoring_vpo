...
# Доходы вуза из иностранных источников {#ind69_info}
...
* 2013,	3,	III.6,	Доходы вуза от выполнения НИОКР и образовательной деятельности из иностранных источников,	тыс. руб.
...
```{r tab69formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab69, , 'tab69_data')
```
