...
# Площадь крытых спортивных сооружений {#ind235_info}
...
* 2013,	8,	11,	Площадь крытых спортивных сооружений,	кв. м.
*	2014,	9,	11,	Площадь крытых спортивных сооружений,	кв. м.
*	2015,	9,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2016,	9,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2017,	9,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2018,	9,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2019,	8,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2020,	8,	43,	Площадь крытых спортивных сооружений,	кв. м.
*	2021,	8,	43,	Площадь крытых спортивных сооружений,	кв. м.
...
```{r tab235formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab235, , 'tab235_data')
```
