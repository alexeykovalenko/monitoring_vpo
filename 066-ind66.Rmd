...
# Доля иностранных (из СНГ) аспирантов {#ind66_info}
...
* 2013,	3,	I3.10,	Удельный вес численности иностранных граждан из стран СНГ из числа аспирантов вуза в общей численности аспирантов,	%
* 2014,	3,	I3.10,	Удельный вес численности иностранных граждан из стран СНГ из числа аспирантов вуза в общей численности аспирантов,	%
* 2015,	3,	I3.11,	Удельный вес численности иностранных граждан из стран СНГ из числа аспирантов образовательной организации в общей численности аспирантов,	%
...
```{r tab66formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab66, , 'tab66_data')
```
