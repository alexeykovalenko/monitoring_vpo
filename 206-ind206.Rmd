...
# Количество технопарков {#ind206_info}
...
* 2013 -
* 2014 - 
*	2015,	9,	14,	Количество технопарков,	ед.
*	2016,	9,	14,	Количество технопарков,	ед.
*	2017,	9,	14,	Количество технопарков,	ед.
*	2018,	9,	14,	Количество технопарков,	ед.
*	2019,	8,	14,	Количество технопарков,	ед.
*	2020,	8,	14,	Количество технопарков,	ед.
*	2021,	8,	14,	Количество технопарков,	ед.
...
```{r tab206formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab206, , 'tab206_data')
```
