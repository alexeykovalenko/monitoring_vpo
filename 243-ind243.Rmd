...
# Доля доходов из федерального бюджета {#ind243_info}
...
* 2013 -
* 2014 -
*	2015,	9,	51,	Доля доходов вуза из федерального бюджета,	%
*	2016,	9,	51,	Доля доходов вуза из федерального бюджета,	%
*	2016,	9,	51,	Доля доходов филиала из федерального бюджета,	%
*	2017,	9,	51,	Доля доходов вуза из федерального бюджета,	%
*	2017,	9,	51,	Доля доходов филиала из федерального бюджета,	%
*	2018,	9,	51,	Доля доходов вуза из федерального бюджета,	%
*	2018,	9,	51,	Доля доходов филиала из федерального бюджета,	%
*	2019,	8,	51,	Доля доходов вуза из федерального бюджета,	%
*	2019,	8,	51,	Доля доходов филиала из федерального бюджета,	%
*	2020,	8,	51,	Доля доходов вуза из федерального бюджета,	%
*	2020,	8,	51,	Доля доходов филиала из федерального бюджета,	%
*	2021,	8,	51,	Доля доходов вуза из федерального бюджета,	%
*	2021,	8,	51,	Доля доходов филиала из федерального бюджета,	%
...
```{r tab243formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab243, , 'tab243_data')
```
