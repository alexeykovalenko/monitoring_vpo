...
# Количество малых предприятий {#ind208_info}
...
* 2013 -
* 2014 - 
*	2015,	9,	16,	Количество малых предприятий,	ед.
*	2016,	9,	16,	Количество малых предприятий,	ед.
*	2017,	9,	16,	Количество малых предприятий,	ед.
*	2018,	9,	16,	Количество малых предприятий,	ед.
*	2019,	8,	16,	Количество малых предприятий,	ед.
*	2020,	8,	16,	Количество малых предприятий,	ед.
*	2021,	8,	16,	Количество малых предприятий,	ед.
...
```{r tab208formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab208, , 'tab208_data')
```
