...
# Объем НИОКР в расчете на одного НПР {#ind53_info}
...
*	2013,	2,	II.6,	Объем НИОКР в расчете на одного НПР,	тыс. руб.
