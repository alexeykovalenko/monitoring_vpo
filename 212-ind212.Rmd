...
# Число диссертационных советов {#ind212_info}
...
* 2013 -
* 2014 - 
*	2015,	9,	20,	Число диссертационных советов,	ед.
*	2016,	9,	20,	Число диссертационных советов,	ед.
*	2017,	9,	20,	Число диссертационных советов,	ед.
*	2018,	9,	20,	Число диссертационных советов,	ед.
*	2019,	8,	20,	Число диссертационных советов,	ед.
*	2020,	8,	20,	Число диссертационных советов,	ед.
*	2021,	8,	20,	Число диссертационных советов,	ед.
...
```{r tab212formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab212, , 'tab212_data')
```
