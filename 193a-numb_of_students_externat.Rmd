...
# Общая численность обучающихся по программам ВПО экстерном  {#ind249_info}
...
* 2013,	8,	1.4,	экстернат,	чел.
*	2014,	9,	1.4,	экстернат,	чел.
*	2015 -
*	2016 -
*	2017 -
*	2018 -
...
```{r ind193a_import, echo = FALSE}
#Чтение таблицы исходных данных подраздела запись данных в переменную
tab193a <- import_table("for_export_ind249.csv")
...
```{r tab193aformation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab193a, , 'tab193a_data')
```
