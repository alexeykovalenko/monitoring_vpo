...
# Доходы из всех источников {#ind240_info}
...
* 2013 -
* 2014 -
*	2015,	9,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2016,	9,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2016,	9,	48,	Доходы филиала из всех источников,	тыс. руб.
*	2017,	9,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2017,	9,	48,	Доходы филиала из всех источников,	тыс. руб.
*	2018,	9,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2018,	9,	48,	Доходы филиала из всех источников,	тыс. руб.
*	2019,	8,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2019,	8,	48,	Доходы филиала из всех источников,	тыс. руб.
*	2020,	8,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2020,	8,	48,	Доходы филиала из всех источников,	тыс. руб.
*	2021,	8,	48,	Доходы вуза из всех источников,	тыс. руб.
*	2021,	8,	48,	Доходы филиала из всех источников,	тыс. руб.
...
```{r tab240formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab240, , 'tab240_data')
```
