...
# Общая площадь зданий (помещений) {#ind231_info}
...
*	2013,	8,	7,	Общая площадь зданий (помещений),	кв. м.
*	2014,	9,	7,	Общая площадь зданий (помещений),	кв. м.
*	2015,	9,	39,	Общая площадь зданий (помещений),	кв. м.
*	2016,	9,	39,	Общая площадь зданий (помещений),	кв. м.
*	2017,	9,	39,	Общая площадь зданий (помещений),	кв. м.
*	2018,	9,	39,	Общая площадь зданий (помещений),	кв. м.
*	2019,	8,	39,	Общая площадь зданий (помещений),	кв. м.
*	2020,	8,	39,	Общая площадь зданий (помещений),	кв. м.
*	2021,	8,	39,	Общая площадь зданий (помещений),	кв. м.
...
```{r tab231formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab231, , 'tab231_data')
```
