...
# Общая численность аспирантов {#ind209_info}
...
* 2013 -
* 2014 - 
*	2015,	9,	17,	Общая численность аспирантов,	чел.
*	2016,	9,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
*	2017,	9,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
*	2018,	9,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
*	2019,	8,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
*	2020,	8,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
*	2021,	8,	17,	Общая численность аспирантов (адъюнктов), интернов, ординаторов, ассистентов-стажеров,	чел.
...
```{r tab209formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab209, , 'tab209_data')
```
