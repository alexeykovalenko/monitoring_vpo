...
# Наименования образовательных организаций  {#ind2_info}



```{r ind2_import, echo = FALSE}
#Чтение таблицы исходных данных подраздела запись данных в переменную
tab2 <- import_table("for_export_ind2.csv")
...
```{r tab2formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab2, , 'tab2_data')
```
