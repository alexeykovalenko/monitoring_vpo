...
# Количество персональных компьютеров {#ind237_info}
...
*	2013 -
*	2014 -
*	2015,	9,	45,	Количество персональных компьютеров,	ед.
*	2016,	9,	45,	Количество персональных компьютеров,	ед.
*	2017,	9,	45,	Количество персональных компьютеров,	ед.
*	2018,	9,	45,	Количество персональных компьютеров,	ед.
*	2019,	8,	45,	Количество персональных компьютеров,	ед.
*	2020,	8,	45,	Количество персональных компьютеров,	ед.
*	2021,	8,	45,	Количество персональных компьютеров,	ед.
...
```{r tab237formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab237, , 'tab237_data')
```
