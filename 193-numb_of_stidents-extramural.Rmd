...
# Общая численность обучающихся по программам ВПО в заочной форме  {#ind193_info}
...
* 2013,	8,	1.3,	по заочной форме обучения,	чел.
*	2014,	9,	1.3,	по заочной форме обучения,	чел.
*	2015,	9,	1.3,	по заочной форме обучения,	чел.
*	2016,	9,	1.3,	по заочной форме обучения,	чел.
*	2017,	9,	1.3,	по заочной форме обучения,	чел.
*	2018,	9,	1.3,	по заочной форме обучения,	чел.
*	2019,	8,	1.3,	по заочной форме обучения,	чел.
*	2020,	8,	1.3,	по заочной форме обучения,	чел.
*	2021, 8,	1.3, 	по заочной форме обучения,	чел.
...
```{r tab193formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab193, , 'tab193_data')
```
