...
# Доля выпускников отчетного года, обратившихся за содействием и признанных безработными {#ind92_info}
...
* 2013,	6,	I6.2,	Удельный вес выпускников отчетного года очной формы обучения, обратившихся за содействием в поиске подходящей работы в органы содействия в трудоустройстве и признанных безработными,	%
* 2013,	6,	VI.2,	Удельный вес выпускников 2012 года очной формы обучения, обратившихся за содействием в поиске подходящей работы и признанных безработными,	%
* 2014,	6,	I6.2,	Удельный вес выпускников отчетного года очной формы обучения, обратившихся за содействием в поиске подходящей работы в органы содействия в трудоустройстве и признанных безработными,	%
...
```{r tab92formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab92, , 'tab92_data')
```
