...
# Доходы вуза из всех источников в расчете на одного НПР {#ind77_info}
...
* 2013,	4,	IV.1,	Доходы вуза из всех источников в расчете на одного НПР,	тыс. руб.
...
```{r tab77formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab77, , 'tab77_data')
```
