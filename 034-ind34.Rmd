...
# Доля остепененных НПР в общей численности НПР  {#ind34_info}
...
* 2013,	1,	I.8,	Доля научно-педагогических работников (далее – НПР), имеющих ученую степень кандидата и доктора наук, в общей численности НПР вуза,	%
