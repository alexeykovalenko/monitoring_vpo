...
# Доля иностранных студентов (из СНГ), завершивших обучение в приведенном выпуске {#ind71_info}
...
* 2013,	3,	III.2,	Удельный вес численности иностранных студентов из стран СНГ, завершивших освоение ООП ВПО, в общем выпуске студентов (приведенный контингент),	%
...
```{r tab71formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab71, , 'tab71_data')
```
