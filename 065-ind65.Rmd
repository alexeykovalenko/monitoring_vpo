...
# Доля иностранных (кроме СНГ) аспирантов {#ind65_info}
...
* 2013,	3,	I3.9,	Удельный вес численности иностранных граждан (кроме стран СНГ) из числа аспирантов вуза в общей численности аспирантов,	%
* 2014,	3, 	I3.9,	Удельный вес численности иностранных граждан (кроме стран СНГ) из числа аспирантов вуза в общей численности аспирантов,	%
* 2015,	3,	I3.10,	Удельный вес численности иностранных граждан (кроме стран СНГ) из числа аспирантов образовательной организации в общей численности аспирантов,	%
...
```{r tab65formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab65, , 'tab65_data')
```
