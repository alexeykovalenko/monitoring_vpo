...
# Доля ППС возрастной категории моложе 65 лет {#ind218_info}
...
*	2013 -
*	2014 -
*	2015,	9,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2016,	9,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2017,	9,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2018,	9,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2019,	8,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2020,	8,	26,	Доля ППС возрастной категории моложе 65 лет,	%
*	2021,	8,	26,	Доля ППС возрастной категории моложе 65 лет,	%
...
```{r tab218formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab218, , 'tab218_data')
```
