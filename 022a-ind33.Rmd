...
# Доля принятых "олимпиадников"  {#ind22а_info}
...
* 2013, 1,	I.3,	Удельный вес численности победителей и призеров заключительного этапа всероссийской олимпиады школьников в общей численности студентов, принятых на первый курс по программам подготовки бакалавров и специалистов на очную форму обучения,	%
...
```{r tab33formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab33, , 'tab33_data')
```
