...
# Доля ППС возрастной категории моложе 40 лет {#ind219_info}
...
*	2013 -
*	2014 -
*	2015,	9,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2016,	9,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2017,	9,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2018,	9,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2019,	8,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2020,	8,	27,	Доля ППС возрастной категории моложе 40 лет,	%
*	2021,	8,	27,	Доля ППС возрастной категории моложе 40 лет,	%
...
```{r tab219formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab219, , 'tab219_data')
```
