...
# Число кандидатов и докторовн наук на 100 студентов {#ind89_info}
...
* 2013 - 
* 2014,	7,	I9.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2015,	7,	I7.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2016,	7,	7.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2017,	7,	7.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2018,	7,	7.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2019,	6,	6.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2020,	6,	6.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
* 2021,	6,	6.4,	Число НПР, имеющих ученую степень кандидата и доктора наук, в расчете на 100 студентов, ед.
...
```{r tab89formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab89, , 'tab89_data')
```
