...
# Количество полученных грантов за отчетный год в расчете на 100 НПР  {#ind50_info}
...
* 2013,	2,	I2.16,	Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2014,	2,	I2.16,	Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2015,	2,	I2.16,	Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2016, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2017, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2018, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2019, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2020, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
* 2021, 2, 2.16, Количество полученных грантов за отчетный год в расчете на 100 НПР, ед.
...
```{r tab50formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab50, , 'tab50_data')
```
