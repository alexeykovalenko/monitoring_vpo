...
* 2013 - 
* 2014,	7,	I9.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2015,	7,	I7.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2016,	7,	7.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2017,	7,	7.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2018,	7,	7.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2019,	6,	6.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2020,	6,	6.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
* 2021,	6,	6.2,	Удельный вес НПР имеющих ученую степень доктора наук, в общей численности НПР, %
...
```{r tab87formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab87, , 'tab87_data')
```
