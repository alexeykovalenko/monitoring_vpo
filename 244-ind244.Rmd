...
# Доля доходов из бюджета субъекта РФ и местного бюджета {#ind244_info}
...
* 2013 -
* 2014 -
*	2015,	9,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2016,	9,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2016,	9,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
*	2017,	9,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2017,	9,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
*	2018,	9,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2018,	9,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
*	2019,	8,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2019,	8,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
*	2020,	8,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2020,	8,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
*	2021,	8,	52,	Доля доходов вуза из бюджета субъекта РФ и местного бюджета,	%
*	2021,	8,	52,	Доля доходов филиала из бюджета субъекта РФ и местного бюджета,	%
...
```{r tab244formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab244, , 'tab244_data')
```
