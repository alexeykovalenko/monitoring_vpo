...
# Общая численность обучающихся по программам ВПО в очно-заочной форме  {#ind192_info}
...
* 2013,	8,	1.2,	в том числе:по очно-заочной (вечерней) форме обучения,	чел.
*	2014,	9,	1.2,	в том числе:по очно-заочной (вечерней) форме обучения,	чел.
*	2015,	9,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2016,	9,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2017,	9,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2018,	9,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2019,	8,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2020,	8,	1.2,	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
*	2021, 8,	1.2, 	в том числе: по очно-заочной (вечерней) форме обучения,	чел.
...
```{r tab192formation, echo = FALSE}
#Вывод таблицы 1.1 в отчет
get_dt(tab192, , 'tab192_data')
```
